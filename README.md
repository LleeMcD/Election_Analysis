...
The original Python algorithm returned information specific to each candidate. The script was then modified to retun additional details at the county level. The algorithm code for each report is in appendix A, which is at the end of this summary.
